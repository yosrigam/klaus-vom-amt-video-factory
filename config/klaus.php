...
return [
    ...
    'narration_volume' => env('KLAUS_NARRATION_VOLUME', 1.35),
    ...
    'narration_styles' => [
        'default' => [
            'rate' => env('EDGE_TTS_RATE', '+4%'),
            'pitch' => env('EDGE_TTS_PITCH', '-3Hz'),
            'volume' => env('EDGE_TTS_VOLUME', '+0%'),
            'sentence_pause_seconds' => env('EDGE_TTS_SENTENCE_PAUSE', 0.30),
            'short_phrase_pause_seconds' => env('EDGE_TTS_SHORT_PHRASE_PAUSE', 0.18),
            'bookend_pause_seconds' => env('EDGE_TTS_BOOKEND_PAUSE', 0.65),
            'line_break_pause_seconds' => env('EDGE_TTS_LINE_BREAK_PAUSE', 0.45),
            'dramatic_pause_multiplier' => 1.0,
            'merge_short_phrases' => env('EDGE_TTS_MERGE_SHORT_PHRASES', true),
        ...
        'awkward' => [
            ...
            'pitch' => env('EDGE_TTS_PITCH', '-3Hz'),
            'volume' => env('EDGE_TTS_VOLUME', '+0%'),
            'sentence_pause_seconds' => env('EDGE_TTS_SENTENCE_PAUSE', 0.08),
            'short_phrase_pause_seconds' => env('EDGE_TTS_SHORT_PHRASE_PAUSE', 0.04),
            'bookend_pause_seconds' => env('EDGE_TTS_BOOKEND_PAUSE', 0.16),
            'line_break_pause_seconds' => env('EDGE_TTS_LINE_BREAK_PAUSE', 0.04),
    ...
    'beat_markers' => [
        'pause' => (float) env('EDGE_TTS_BEAT_PAUSE', 0.45),
        'beat' => (float) env('EDGE_TTS_BEAT_BEAT', 0.65),
        'long_beat' => (float) env('EDGE_TTS_BEAT_LONG_BEAT', 0.95),
    ],
    'edge_tts_trim_trailing_silence' => env('EDGE_TTS_TRIM_TRAILING_SILENCE', true),
    'edge_tts_trim_silence' => [
        'stop_threshold_db' => (int) env('EDGE_TTS_TRIM_SILENCE_THRESHOLD_DB', -45),
        'stop_duration_seconds' => (float) env('EDGE_TTS_TRIM_SILENCE_DURATION', 0.06),
    ],
    ...
    'edge_tts_merge_short_phrases' => env('EDGE_TTS_MERGE_SHORT_PHRASES', true),
    ...
    'edge_tts_bookend_pause_seconds' => env('EDGE_TTS_BOOKEND_PAUSE', 0.65),
    'edge_tts_rate' => env('EDGE_TTS_RATE', '+4%'),
