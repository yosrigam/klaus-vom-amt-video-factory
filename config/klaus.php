...
return [
    ...
    'voice_profile' => [
        ...
        'merge_short_phrases' => env('EDGE_TTS_MERGE_SHORT_PHRASES', false),
        'sentence_pause' => env('EDGE_TTS_SENTENCE_PAUSE', 0.50),
        'short_phrase_pause' => env('EDGE_TTS_SHORT_PHRASE_PAUSE', 0.35),
        'bookend_pause' => env('EDGE_TTS_BOOKEND_PAUSE', 1.0),
        'pre_punchline_pause' => env('EDGE_TTS_PRE_PUNCHLINE_PAUSE', 0.45),
        'punchline_pause' => env('EDGE_TTS_PUNCHLINE_PAUSE', 0.95),
        'paragraph_break_pause' => env('EDGE_TTS_PARAGRAPH_BREAK_PAUSE', 0.45),
        'line_break_pause' => env('EDGE_TTS_LINE_BREAK_PAUSE', 0.12),
        'delivery_styles' => [
            'NeutralObservation' => [
                'rate' => '-2%',
                'pitch' => '-2Hz',
